...
def om_summary_stats(om_df, meta_df, om_col_dict, meta_col_dict):
    ...
    om_df[meta_cod] = om_df[meta_cod].dt.floor('D')  # hour on commisioning data is unimportant for this analysis
    ...
    om_df[om_age_st] =\
        om_df[om_age_st].dt.round('D').dt.days
    om_df[om_rep_dur] =\
        om_df[om_rep_dur].dt.seconds/3600.
