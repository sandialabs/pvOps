...
def prod_quant(prod_df, prod_col_dict, comp_type, ecumu=True):
    ...
    for rid in prod_df.index.unique():
        ...
        if comp_type == 'diff':
            prod_df.loc[rid, quant_ener] = prod_df.loc[rid, baseline_ener] - prod_df.loc[rid, pstep_ener]

        elif comp_type == 'norm':
            prod_df.loc[rid, quant_ener] = prod_df.loc[rid, pstep_ener]/prod_df.loc[rid, baseline_ener]
