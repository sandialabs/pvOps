def get_CEC_params(name, mod_spec):
    ...
    module_parameters['ncells_substring'] = module_parameters['N_s'] / mod_spec['nsubstrings']
    module_parameters['nrows'] = module_parameters['N_s'] / module_parameters['ncols']
    ...
    cell_parameters['a_ref'] = module_parameters['a_ref'] / module_parameters['N_s']
    cell_parameters['R_sh_ref'] = module_parameters['R_sh_ref'] / module_parameters['N_s']
    cell_parameters['R_s'] = module_parameters['R_s'] / module_parameters['N_s']
