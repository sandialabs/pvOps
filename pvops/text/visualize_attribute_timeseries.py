...
def visualize_attribute_timeseries(om_df, om_col_dict, date_structure='%Y-%m', figsize=(12,6), cmap_name='brg'):
    ...
    datetime_list = [datetime.datetime.strptime(i,date_structure) for i in full_date_list]
