...
class Doc2VecModel(BaseEstimator):
    ...
    '''
    def __init__(self,vector_size=100, dm_mean=None, dm=1, 
                dbow_words=0, dm_concat=0, dm_tag_count=1, dv=None, 
                dv_mapfile=None, comment=None, trim_rule=None, 
    ...
    def fit(self, raw_documents, y=None):
        ...
        # Tag docs
        tagged_documents = [TaggedDocument(words=word_tokenize(_d.lower()), tags=[str(i)]) for i, _d in enumerate(raw_documents)]
        # Build vocabulary
