...
def visualize_attribute_connectivity(om_df, om_col_dict, figsize=(40,20), attribute_colors = ['lightgreen', 'cornflowerblue'], edge_width_scalar = 10, graph_aargs = {}):
    ...
    fig.suptitle(f'Connectivity between {ATTRIBUTE1_COL} and {ATTRIBUTE2_COL}', fontsize=50, y=1.08, fontweight='bold')
