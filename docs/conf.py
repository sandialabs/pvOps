...
MODULES = ['numpy', 'nltk', 'sklearn.pipeline', 'sklearn.model_selection',
           ...
           "sklearn.cluster", "networkx", "matplotlib", "matplotlib.pyplot",
           "gensim.models.doc2vec", "sklearn.feature_extraction.text",
           "nltk.tokenize", "plotly.graph_objects", "scipy.signal",
           'matplotlib.colors', 'seaborn', 'matplotlib.ticker',
